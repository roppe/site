<?php
	...
	define('CAPTCHA_SECRET', '#captchasectet'); 

	$EmailFrom = "leads@bronxbathtubreglazing.com";

	$EmailTo = "info@bronxbathtubreglazing.com";

	$Subject = "Lead from:  bronxbathtubreglazing.com";
